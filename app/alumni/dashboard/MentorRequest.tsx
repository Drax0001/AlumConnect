  ...
  return (
    <div className='bg-white font-satoshi border border-backgroundGray p-5 rounded-md flex flex-col gap-y-12'>
        <div className='self-center flex flex-col items-center'>
            <h1 className='text-2xl font-inter font-bold text-primary'>Mentoring Request</h1>
        ...
        <div className='flex flex-col gap-y-4'>
            {mentors.map(card => (
                <div key={card.title} className='bg-primaryLight2 p-4 flex rounded-md items-center justify-between'>
                    ...
                    <div>
                        <Link href='#' className='border border-backgroundGray rounded-md py-1.5 px-3 bg-white font-bold w-fit'>Approve</Link>
                    </div>
                </div>
            ))}
        </div>
