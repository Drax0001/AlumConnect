...
export async function POST(request: NextRequest) {
    ...
    if (!student) {
        return NextResponse.json({ message: 'This student does not exist' }, { status: 404, statusText: 'Not Found' })
    }
    ...
    return NextResponse.json({ data: studentWithoutPassword, token: jwt, message: 'Student Successfully Logged in' }, { status: 200, statusText: 'Login Successful' })
}
